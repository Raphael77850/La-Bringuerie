  ...
  JWT: {
    SECRET:
      ...
      (() => {
        if (process.env.NODE_ENV === "production") {
          console.warn(
            "⚠️  SECURITY WARNING: Using fallback JWT_SECRET for Railway deployment",
          );
          console.warn(
            "⚠️  Please set JWT_SECRET environment variable in Railway Dashboard",
          );
    ...
    REFRESH_SECRET:
      ...
      (() => {
        if (process.env.NODE_ENV === "production") {
          console.warn(
            "⚠️  SECURITY WARNING: Using fallback JWT_REFRESH_SECRET",
          );
